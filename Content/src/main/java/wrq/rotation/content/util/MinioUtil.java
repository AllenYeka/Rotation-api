...
public class MinioUtil {
    ...
    public String upload(String fileName, InputStream file,String bucketName) {//网络文件上传
    ...
    public String LocalUpload(String fileName,String bucketName) {//本地文件上传
        String objectName=fileName.substring(fileName.lastIndexOf("\\")+1);
        try {
    ...
    public void download(String objectName,String localPath,String bucketName){//文件下载
    ...
    public String prePicture(String objectName,String bucketName){//预览图片
        // 查看文件地址
    ...
    public List<Item> fileList(String bucket) {//查看当前bucket的所有文件
    ...
    public boolean removeFile(String objectName,String bucketName) {//删除文件对象
        try {
